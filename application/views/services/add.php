...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
	...
	<div class="card"> 
		...
		<div class="card-body">
			<?=form_open(base_url().'services/proceedadd')?>
...
<?php } ?>
		        <div class="form-group">
		            ...
		            <input id="inputUserName" type="text" name="s_name" data-parsley-trigger="change" required="" placeholder="Enter service name" autocomplete="off" class="form-control">
		        </div>
				<div class="form-group">
				    <label for="exampleFormControlTextarea1">Service Description</label>
				    <textarea name="s_description" class="form-control" placeholder="Enter service discription" id="exampleFormControlTextarea1" rows="3"></textarea>
				</div>
