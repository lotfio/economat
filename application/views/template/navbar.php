                                            ...
                                            <a href="#" class="list-group-item list-group-item-action active">
                                                <div class="notification-info">
                                                    <div class="notification-list-user-img">
                                                        ...
                                                        <img src="<?=base_url()?>assets/images/avatar-2.jpg" alt="" class="user-avatar-md rounded-circle">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <?php if(!empty($user->u_img) && file_exists(UP_IMG.$user->u_img)):?>
                                    <img src="<?=base_url()?>assets/images/<?=$user->u_img?>" alt="User Avatar" class="user-avatar-md rounded-circle" >
                                <?php else:?>
                                    <img src="<?=base_url()?>assets/images/avatar.svg" alt="User Avatar" class="user-avatar-md rounded-circle">
                                <?php endif?>
